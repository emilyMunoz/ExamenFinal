...
public class view4 extends AppCompatActivity implements View.OnClickListener
{
    private Button goHomeFromView4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goHomeFromView4 = findViewById(R.id.homeView4);
    ...
    public void goHomeFromView4(View view) {
